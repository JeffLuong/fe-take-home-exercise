const markdownPreviews = [
    ['heading 1', '# lorem ipsum', '<h1 id="lorem-ipsum">lorem ipsum</h1>'],
    ['heading 2', '## lorem ipsum', '<h2 id="lorem-ipsum">lorem ipsum</h2>'],
    ['heading 3', '### lorem ipsum', '<h3 id="lorem-ipsum">lorem ipsum</h3>'],
...
1. Eggs
1. Bacon`,
        '<ol start="1"><li>Milk</li><li>Eggs</li><li>Bacon</li></ol>',
    ],
